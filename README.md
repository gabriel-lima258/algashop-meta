...
| [`algashop-docs`](https://github.com/gabriel-lima258/algashop-docs) | **O caderno de estudos** — 55 documentos sobre o que foi aplicado e por quê |
...
| Kafka (3 brokers) | **9092-9094** | cluster KRaft de 3 nós — eventos de integração entre os serviços |
| Kafka UI | **9084** | tópicos, partições, offsets e consumer lag |
...
2. [Linha do tempo](https://github.com/gabriel-lima258/algashop-docs/blob/main/00-visao-geral/linha-do-tempo.md) — a jornada em 40 fases, e por que nessa ordem
...
O índice completo dos 55 documentos está no [`algashop-docs`](https://github.com/gabriel-lima258/algashop-docs).
