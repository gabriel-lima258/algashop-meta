...
| [`algashop-docs`](https://github.com/gabriel-lima258/algashop-docs) | **O caderno de estudos** — 26 documentos sobre o que foi aplicado e por quê |
...
2. [Linha do tempo](https://github.com/gabriel-lima258/algashop-docs/blob/main/00-visao-geral/linha-do-tempo.md) — a jornada em 16 fases, e por que nessa ordem
...
O índice completo dos 26 documentos está no [`algashop-docs`](https://github.com/gabriel-lima258/algashop-docs).
